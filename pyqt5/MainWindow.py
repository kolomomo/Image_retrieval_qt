...
from models.pre_models import CenterVLAD
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def viewfiles(self):
        ...
        if not self.model:
            self.model=load_model('./query_models/query_CenterVLAD_plus.h5',
            ...
            self.F = cPickle.load(open('./qurey_samples/CenterVLAD_plus-feature-SData', "rb", True))
